...
const QuitAppModal = (props: any) => {
  const [language, setlanguage] = useState({main: {cancel: '', okay: ''}, quit: {desc: '', quitBtn: ''}});
  const [langstr, setlangstr] = useState({main: {cancel: '', okay: ''}, quit: {desc: '', quitBtn: ''}});
      ...
      <View style={styles.container}>
        ...
        <View style={styles.btnContainer}>
          <TouchableOpacity
            ...
            <Text style={[styles.title, {fontSize: 14,color:'#fff'}]}>{langstr.main.cancel}</Text>
          </TouchableOpacity>
          <TouchableOpacity
